...
import { motion, AnimatePresence, type Transition, type VariantLabels } from 'framer-motion';
type Target = any;
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  return (
    <motion.span className={cn(mainClassName)} {...rest} layout transition={transition}>
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        <motion.span key={currentTextIndex} layout aria-hidden="true">
          {elements.map((wordObj, wordIndex, array) => {
            ...
            return (
              <span key={wordIndex} className={cn(splitLevelClassName)}>
